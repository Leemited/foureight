...
<div id="qa_list">
    ...
    <div class="qa_container">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02"><img src="<?php echo G5_IMG_URL;?>/ic_board_add.svg" alt=""></a></li><?php } ?>
        </ul>
         <!-- 게시판 페이지 정보 및 버튼 시작 { --
        <div class="bo_fx">
        ...
        <div class="ul_wrap ul_01">
            <ul>
                ...
                ?>
                <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>" onclick="location.href='<?php echo $list[$i]['view_href']; ?>'">
                    <?php if ($is_checkbox) { ?>
                    <div class="li_chk">
                    ...
                    <?php } ?>
                    <div class="li_title">
                        <h2><strong>[<?php echo $list[$i]['category']; ?>]</strong>
                        <?php echo $list[$i]['subject']; ?></h2>
                    </div>
                    <div class="li_info">
                        <!--<span><?php /*echo $list[$i]['num']; */?></span>-->
                        <span><?php echo ($list[$i]['mb_name'])?$list[$i]["mb_name"]:"비회원"; ?></span>
