...
<!--		<div class="right"><img src="--><?php //echo G5_IMG_URL?><!--/ic_menu_option.svg" alt=""></div>-->
	...
	<div id="mb_login" class="mbskin">
		...
		<input type="hidden" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input required nospace" maxlength="20">
		<div class="tbl_frm01 tbl_wrap">
			...
			<input type="password" name="mb_password" id="reg_mb_password" class="frm_input" minlength="3" maxlength="20" <?php echo $required ?> placeholder="비밀번호" />
			<input type="password" name="mb_password_re" id="reg_mb_password_re" class="frm_input " minlength="3" maxlength="20" <?php echo $required ?> placeholder="비밀번호 확인" >
		...
		<div class="tbl_frm01 tbl_wraps">
			<input type="text" name="mb_hp" value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="frm_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="20" placeholder="전화번호"  style="margin-bottom:0">
            <input type="button" value="인증하기" id="win_hp_cert">

			<?php if ($config['cf_cert_use'] && $config['cf_cert_hp']) { ?>
			<input type="hidden" name="old_mb_hp" value="<?php echo get_text($member['mb_hp']) ?>">
			<?php } ?>
			<!--<input type="text" name="mb_hp_confirm" value="<?php /*echo get_text($member['mb_hp']) */?>" id="reg_mb_hp_confirm" <?php /*echo ($config['cf_req_hp'])?"required":""; */?> class="frm_input <?php /*echo ($config['cf_req_hp'])?"required":""; */?>" maxlength="20" placeholder="인증번호" >-->
			<!--<table>
		...
		<section>
			<div class="login_link">
				이미 계정이 있으신가요?<a href="./login.php" class="register_link"> 로그인 하기</a>
			</div>
		</section>
		</form>
