...
<div class="wrap">
	...
	<div id="mb_login" class="mbskin">
		...
		<div id="login_frm">
            ...
            <input type="email" name="mb_id" id="login_id" placeholder="이메일" required class="frm_input" placeholder="" autocomplete="off" value="<?php echo $_REQUEST["mb_id"];?>" onkeyup="checkAdmin(this.value);">
		...
		<section>
			...
			<div>
				<input type="submit" value="로그인" class="btn_submit <?php if($_SESSION["type1"]==2 || $_SESSION["type1"]==""){?>bg2<?php }?>">
