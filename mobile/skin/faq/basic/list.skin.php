...
<div id="faq_wrap" class="faq_<?php echo $fm_id; ?>">
    ...
    <div class="faq_cate">
        <ul>
            ...
            <li onclick="location.href='<?php echo G5_BBS_URL?>/faq.php?fm_id=1&fa_cate=기타';" <?php if($fa_cate=="기타"){echo "class='active'";}?>>기타</li>
        </ul>
        <div class="clear"></div>
    </div>
    <!--<div id="bo_sch">
    ...
    <section id="faq_con">
        ...
        <ol>
            ...
            <li>
                <div class="left">
                    <h3><a href=""><p><?php echo $v["fa_cate"];?></p></a></h3>
                </div>
                <div class="right">
