    ...
    <div class="board_container">
        <!--<fieldset id="bo_sch">
            ...
            <form name="fsearch" method="get">
                ...
                <input name="stx" value="<?php /*echo stripslashes($stx) */?>" placeholder="검색어(필수)" required id="stx" class="input01" size="" maxlength="20" >
        ...
        <div id="bo_list<?php if ($is_admin) echo "_admin"; ?>">
            ...
            <div class="bo_fx">
                ...
                <ul class="btn_bo_user">
                    <li><?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_b02 btn_submit">글쓰기</a><?php } ?></li>
                </ul>
            </div>
            <?php } ?>
            </form>
