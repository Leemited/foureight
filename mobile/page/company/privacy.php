...
<div class="help" style="">
    ...
    <div>제 1 조 (목적) 본 약관은 회원( 48 서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다.)</div>
    <p>이 디자인율 (이하 "회사"라고 합니다.)이 제공하는 앱 서비스(이하 "서비스"라고 합니다)를 이용함에
        있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
    <div>제 2 조 (이용약관의 효력 및 변경)</div>
    <ul>
    ...
    <div>제 3 조 (관계법령의 적용) 본 약관은 신의성실의 원칙에 따라 공정하게 적용하며, 본 약관에 명시되지 아니한 사항에 대하여는 관계법령 또는 상관례에 따릅니다.</div>

    <div>제 4 조 (서비스의 내용) 회사가 제공하는 서비스는 아래와 같습니다.</div>
    <ul>
        <li>서비스 명 : 게시물 위치정보 </li>
        <li>서비스 내용 : 사용자간의 원할한 직거래를 위한 위치정보를 수집 및 제공 하고 있습니다.</li>
    </ul>

    <div>제 5 조 (서비스 이용요금)</div>
    <ul>
    ...
    <div>제 8 조 (개인위치정보의 이용 또는 제공)</div>
    <ul>
        ...
        <li>④ 회사는 개인위치정보를 회원이 지정하는 제3자에게 제공하는 경우에는 개인위치정보를 수집한 당해 통신 단말장치로 매회 회원 에게 제공받는 자, 제공 일시 및 제공목적을 즉시 통보합니다. 단, 아래 각 호의 1에 해당하는 경우에는 회원이 미리 특정하여 지정한 통신 단말장치 또는 전자우편주소로 통보합니다.
            <ul>
    ...
    <div>제 11 조 (8세 이하의 아동 등의 보호의무자의 권리)</div>
    <ul>
    ...
    <div>제 17 조 (회사의 연락처) 회사의 상호 및 주소 등은 다음과 같습니다.</div>
    <ul>
        <li>1. 상     호 : 디자인율</li>
        <li>2. 대 표 자 : 김용호</li>
        <li>3. 주     소 : 충청북도 청주시 흥덕구 풍산로 133번길 48</li>
        <li>2. 대표전화 : 070 4090 4811</li>
    </ul>

    <h2>부 칙</h2>
    <div>제1조 (시행일) 이 약관은 20181201 부터 시행한다.</div>
    <div>제2조 위치정보관리책임자는 20181201 을 기준으로 다음과 같이 지정합니다.</div>
    <ul>
        <li>1. 소     속 : 디자인율</li>
        <li>2. 연 락 처 : 070 4090 4811</li>
    </ul>
