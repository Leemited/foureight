    ...
    <div class="w3-modal-content w3-card-4">
        <div class="w3-container">
            ...
            <div>
                ...
                <input type="button" value="상세보기" id="blind_view_btn" style="width:auto" onclick="fnDetailBlind('<?php echo $pd_id;?>')">
...
<script>
function fnDetailBlind(pd_id){
    socket.emit('add connect', {pd_id: pd_id, cnt_type: "minus", pd_mb_id: pd_mb_id, mb_id: mb_id});
    location.href='http://484848.co.kr/mobile/page/mypage/blind_view.php?pd_id='+pd_id+'&backurl=<?php echo G5_MOBILE_URL.'/page/mypage/mypage.php';?>'
}
</script>