...
if($mySetting["my_locations"]) {
    $mylocations = array_filter(explode(",", $mySetting["my_locations"]));
    $mylat = array_filter(explode(",", $mySetting["location_lat"]));
    $mylng = array_filter(explode(",", $mySetting["location_lng"]));
}
?>
