...
<div id="id05" class="w3-modal w3-animate-opacity no-view">
    <div class="w3-modal-content w3-card-4">
        <div class="w3-container">
            ...
            <div>
                <input type="button" value="취소" onclick="modalClose(this)"><input type="button" value="확인" onclick="fnFinLikeUpdate('<?php echo $pd_id;?>','<?php echo $od_id;?>','<?php echo $fin_type;?>');" style="margin-right: 1vw;" ><input type="button" value="평가안함" onclick="fnFinUpdate('<?php echo $pd_id;?>','<?php echo $od_id;?>');" style="width: auto">
            </div>
        </div>
    </div>
</div>
