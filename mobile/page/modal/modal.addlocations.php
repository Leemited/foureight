...
<div id="id03" class="w3-modal w3-animate-opacity no-view" style="padding-top:0;">
    <div class="w3-modal-content w3-card-4" >
        <div class="w3-container">
            ...
            <div>
                <input type="button" value="취소" onclick="$('.write_form form input,.write_form form select,.write_form form textarea').removeAttr('disabled');modalClose()"><!--<input type="button" value="확인" onclick="fnLocs();">-->
            </div>
            <br><br><br>
            <h2>간편 거래위치 선택 </h2>
            <div>
                ...
                <?php }else{ ?>
                    <p>MYPAGE -> 설정 -> 거래위치설정에서 등록/설정 가능합니다.</p>
                    <input type="button" value="마이페이지" onclick="location.href=g5_url+'/mobile/page/mypage/my_location.php'" style="width: auto;margin-top:4vw">
                <?php }?>
            </div>
        </div>
    </div>
