...
<div class="sub_head" style="background-color: #fff;">
    ...
    <h2 class="titles">신고유형 선택</h2>
</div>
<div class="blind_write" id="settings">
    <form action="<?php echo G5_MOBILE_URL?>/page/blind_write_update.php" method="post" onsubmit="return chkSubmit('<?php echo $pd_id;?>');">
        ...
        <div class="setting_wrap">
            <ul>
                ...
                <li><input type="radio" name="blind_con" id="type6" value="기타" ><label for="type6"><span class="outside"><span class="inside"></span></span>기타
                    <input type="text" class="setting_input border-bottom " placeholder="150자 내외 입력" name="blind_con_txt" id="blind_con_txt" style="width:80%;-webkit-border-radius: 0;-moz-border-radius: 0;border-radius: 0;" ></label>
                </li>
            </ul>
        </div>
        <div class="btn_group">
            <input type="submit" value="신고하기" class="setting_btn" onclick="">
        </div>
    </form>
</div>
<script>
