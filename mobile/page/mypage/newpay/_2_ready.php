...
include_once ("../../../../common.php");
    ...
    $apiKey = "U1FVQVJFLTEwMzEwODIwMTkwMjEzMTMwODQyMjAyNzYz";
    ...
    ******************************************************************************************/
	...
	//$goodsName = urlencode($_REQUEST["goodsName"]);
	$goodsName = $_REQUEST["goodsName"];
	/* 상품코드 max 8byte*/
	$goodsCode = $_REQUEST["goodsCode"];
	/*인증완료 시 호출되는 상점 URL (PG->가맹점)*/
	$approvalUrl = G5_URL."/mobile/page/mypage/newpay/_3_approval.php"; //변경 필수
	/*결제창 close시 호출되는 상점URL (PG->가맹점)*/
	$closeUrl = G5_URL."/mobile/page/mypage/newpay/_3_close.php"; //변경 필수
	...
	******************************************************************************************/
	...
	/*$sql = "update `order` set aid = '{$aid}' where od_id = '{$od_id}'";
	sql_query($sql);*/
