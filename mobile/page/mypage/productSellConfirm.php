...
if(sql_query($sql)){
    ...
    send_FCM($mb["regid"], $pro["pd_tag"], cut_str($pro["pd_tag"],10,"...") . "의 구매가 확정되었습니다.\r\n거래중 문의사항은 간편대화 및 연락하기를 통해 가능합니다.\r\n마이페이지 > 거래진행중에서 확인 가능합니다.", G5_MOBILE_URL . "/page/mypage/mypage_order.php?type=2&od_cate=2&pd_type=".$pro["pd_type"], 'pricing_set', '제시/딜 알림', $mb["mb_id"], $pd_id, $img);
