...
if($type==0){//요청
    ...
    if(sql_query($sql)){//판매자에게 요청알림
        ...
        if($mb["regid"]){
            ...
            send_FCM($mb["regid"], " 48 결제 취소 요청", cut_str($pro["pd_tag"],10,"...") . "의 결제취소 요청입니다.\r\n결제취소 사유를 확인 후 진행 바랍니다.\r\n기타 문제시 관리자에게 문의바랍니다.", G5_MOBILE_URL . '/page/mypage/mypage_order.php?type=2&od_cate=1&pd_type=' . $pro["pd_type"], 'fcm_buy_channel', '구매일림', $mb["mb_id"], $pro['pd_id'], $img);
    ...
    if(sql_query($sql)){//구매자 알림
        ...
        if($mb["regid"]){
            ...
            send_FCM($mb["regid"], "48 결제 취소 요청", cut_str($pro["pd_tag"],10,"...") . "의 결제취소 요청이 거절되었습니다.\r\n결제취소 사유를 확인 후 진행 바랍니다.\r\n기타 문제시 관리자에게 문의바랍니다.", G5_MOBILE_URL . '/page/mypage/mypage_order.php?type=2&od_cate=2&pd_type=' . $pro["pd_type"], 'fcm_buy_channel', '구매일림', $mb["mb_id"], $pro['pd_id'], $img);
