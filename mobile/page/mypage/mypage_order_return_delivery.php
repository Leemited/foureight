...
if(sql_query($sql)){
    ...
    if($mb["regid"]) {
        ...
        send_FCM($mb["regid"], '환불 배송 알림', cut_str($pd["pd_tag"],6,"...").'의 환불 배송 정보가 등록되었습니다.', G5_MOBILE_URL.'/page/mypage/mypage_order.php?od_cate=1&pd_type='.$pd["pd_type"], 'fcm_buy_channel', '구매일림', $mb['mb_id'], $pd_id, $img);
    }
