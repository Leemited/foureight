...
function fnTalk2(read_mb_id,pd_id,roomid,type,pd_type){
    ...
    var link = encodeURI(g5_url+"/mobile/page/mypage/mypage_order.php?od_cate="+od_cate);
...
function fnConfirmDelivery(od_id,pd_id,pd_type,status){
    //var od_id = $("#deli_od_id").val();
    var delivery_name = $("#delivery_name").val();
    var delivery_number = $("#delivery_number").val();
    ...
    console.log(delivery_name+"//"+delivery_number+"//"+status);

    //택배검증
    fnDeliveryConfirm(delivery_name,delivery_number,pd_type,pd_id,od_id,0,status);
