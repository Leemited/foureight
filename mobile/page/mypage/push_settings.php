...
<div id="settings">
	...
	<div class="setting_wrap">
		...
		<ul>
			...
			<li class="select_time">시작시간 <select id="etiquette_time_start" class="setting_input" name="etiquette_time_start"><?php for($i=0;$i<25;$i++){?><option value="<?php $time = (count($i)<0)?"0".$i:$i; echo $time?>" <?php if($settings["etiquette_time_start"]==$time){?>selected<?php }?>><?php echo $time;?>시</option><?php }?></select></li>
			<li class="select_time">종료시간 <select id="etiquette_time_end" class="setting_input" name="etiquette_time_end"><?php for($i=0;$i<25;$i++){?><option value="<?php $time2 = (count($i)<0)?"0".$i:$i; echo $time2?>" <?php if($settings["etiquette_time_end"]==$time2){?>selected<?php }?>><?php echo $time2;?>시</option><?php }?></select></li>
		</ul>
	</div>
</div>
<script>
