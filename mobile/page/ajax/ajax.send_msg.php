...
if(sql_query($sql)){
    ...
    $result = send_FCM($mb["regid"], "48 대화 알림", $member["mb_id"]."님의 \r\n대화가 등록되었습니다.\r\n".cut_str($message,20,"..."), G5_MOBILE_URL . "/page/talk/talk_view.php?pd_id=".$pd_id."&send_mb_id=".$member["mb_id"]."&roomid=".$roomid, "chat_alarm_set", "대화알림", $read_mb_id, $pd_id, $img,$message,$roomid);
