    ...
    if($set["chat_set"]=="1"){
        if($pd_id) {
            ...
            if($member["mb_id"]==$mb["mb_id"]) {
                $result["obj"] .= "<li onclick=\"fnTalk()\"><img src='" . G5_IMG_URL . "/view_menu_talk.svg' alt=''><span>대화하기</span></li>";
            }else{
                $result["obj"] .= "<li onclick=\"fnTalk('".$mb["mb_id"]."')\"><img src='" . G5_IMG_URL . "/view_menu_talk.svg' alt=''><span>대화하기</span></li>";
            }
        }
    }
}
