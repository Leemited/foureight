...
<div id="ft">
    <div id="ft_copy">
        <ul>
			...
			<li onclick="location.href=g5_url+'/mobile/page/productmap/?sc_id=<?php echo $sc_id;?>&lat=<?php echo $_SESSION["lat"];?>&lng=<?php echo $_SESSION["lng"];?>'"><img src="<?php echo G5_IMG_URL?>/bottom_icon_04.svg" alt="지도보기"></li>
		</ul>
    </div>
    <!--<div class="footer">
